...
function Confirmedpdf() {
    ...
    const fetchData = () => {
        axios.get(`http://localhost:3001/isfine/${id}`)
            .then((res) => {
                if (res.data.usersWithFine.length > 0) {
                    ...
                    console.log(usersWithFineArray);
                                        ...
                                        <tr key={user._id}>
                                            ...
                                            <td>
                                                {tegiven && tegiven.includes(user._id) ? (
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-check text-success" viewBox="0 0 16 16">
